...
export function initializeDemoData(): void {
  ...
  if (seniors.length === 0) {
    const demoSeniors: Omit<SeniorProfile, 'id' | 'createdAt'>[] = [
      ...
      },
      {
        ...
        bio: 'Frontend-focused developer with strong React and UI fundamentals.',
        priorityScore: 72,
      },
      {
  userId: 'demo7',
  ...
  bio: 'Working on NLP-based ML models and research projects.',
  priorityScore: 78,
},
{
  userId: 'demo8',
...
},
{
  ...
  availabilityStatus: 'active',
  mentorIntent: ['project', 'internship'],
  bio: 'Data analyst intern with hands-on analytics projects.',
  priorityScore: 70,
},
{
  userId: 'demo10',
  ...
  availabilityStatus: 'active',
  mentorIntent: ['project', 'career'],
  bio: 'Cybersecurity enthusiast with CTF and network security experience.',
  priorityScore: 62,
},
{
  userId: 'demo11',
  ...
  bio: 'Backend developer placed at a SaaS company.',
  priorityScore: 92,
},
{
  userId: 'demo12',
